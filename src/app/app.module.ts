...
@NgModule({
  declarations: [AppComponent, DashboardComponent , InvoicesComponent, CheckoutComponent, WithouttaxInvoiceComponent, WithoutTaxInvoiceRimsComponent, TaxInvoiceRimsComponent, InvoiceDetailsComponent, FooterComponent],
  imports: [
    MatToolbarModule,
    RouterModule,
    BrowserModule,
